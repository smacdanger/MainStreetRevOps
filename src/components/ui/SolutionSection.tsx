      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          ...
          <h2 className="text-3xl font-bold text-slate-900 mb-4">
            Modern Revenue Operations That Actually Drive Growth
          </h2>
          <p className="text-lg text-slate-600 max-w-3xl mx-auto">
            We design and implement complete automation systems that transform your manual processes into competitive advantages — using the tools that work best for YOUR business.
          </p>
        </div>
