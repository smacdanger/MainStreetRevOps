...
const FeatureCard: React.FC<FeatureCardProps> = ({
  ...
  return (
    <motion.div
      ...
      className={`group relative bg-white p-8 rounded-2xl shadow-sm hover:shadow-xl transition-all duration-300 border border-slate-200 hover:border-teal-300 ${className}`}
    >
      {/* Gradient overlay */}
      <motion.div 
